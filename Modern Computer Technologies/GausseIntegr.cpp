...
const std::array<double, 4> GausseIntegr::GaussePoints = { root2_1, -root2_1, root2_2, -root2_2 };
const std::array<double, 4> GausseIntegr::GausseWights = { weight1, weight1, weight2, weight2 };

double GausseIntegr::itegrate(double xLeft, double xRight, double yLeft, double yRight, std::function<double(double, double)> funct)
{
	if (xRight < xLeft)
